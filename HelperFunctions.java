...
public class HelperFunctions {
  ...
  */
  ...
  /**
   This function detects triangular structures and returns the nodes involved in the traingle
   @param e An array containing the ColEdge objects of the provided graph
   @return A string containing the nodes that form the triangle
   */
  public static String getHintTriangles (ColEdge[] e) {
    int [][] triangleNodes = TriangleDetection.getNodesOfTriangles(e);
    int [] triangleRequested = new int [3];
    triangleRequested[0] = triangleNodes[0][0];
    triangleRequested[1] = triangleNodes[0][1];
    triangleRequested[2] = triangleNodes[0][2];
    return Arrays.toString(triangleRequested);
  }
